...
#	self.material_override.set_shader_parameter("size", Vector2(5.12 * 100, 2.56 * 100))
	...
	label_node.global_transform.origin =  ( label_node.global_transform.origin * VIEW_MATRIX + Vector3(origin_offset.x, origin_offset.y, 0)) * VIEW_MATRIX.inverse() 
